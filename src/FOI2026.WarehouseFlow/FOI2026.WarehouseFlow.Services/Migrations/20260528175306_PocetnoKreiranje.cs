...
namespace FOI2026.WarehouseFlow.Services.Migrations
{
    /// <inheritdoc />
    public partial class PocetnoKreiranje : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeliveryNotes_Articles_ArticleId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DeliveryNotes_Partners_PartnerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeliveryNoteItems", x => new { x.DeliveryNoteId, x.ArticleId });
                    table.ForeignKey(
                        name: "FK_DeliveryNoteItems_Articles_ArticleId",
                        column: x => x.ArticleId,
                        principalTable: "Articles",
                        principalColumn: "ArticleId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryNoteItems_ArticleId",
                table: "DeliveryNoteItems",
                column: "ArticleId");

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryNotes_ArticleId",
                table: "DeliveryNotes",
                column: "ArticleId");
