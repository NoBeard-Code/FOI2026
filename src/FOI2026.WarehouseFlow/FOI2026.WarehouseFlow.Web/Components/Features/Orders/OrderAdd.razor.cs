...
namespace FOI2026.WarehouseFlow.Web.Components.Features.Orders
{
    ...
    public partial class OrderAdd
    {
        ...
        private List<OrderStavka> stavke = new();
        ...
        private async Task Spremi()
        {
            ...
            {
                greska = "Molimo odaberite dobavljača s popisa.";
                return;
            }
            ...
            var narudzba = new Order
            {
                ...
                OrderItems = stavke.Select(s => new OrderItem
                {
